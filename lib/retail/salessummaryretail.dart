...
class SaleSummaryRetail extends StatefulWidget {
  // Renamed to SoldItemsReport
  const SaleSummaryRetail({super.key});

  @override
  State<SaleSummaryRetail> createState() => _SaleSummaryRetailState();
}
...
class _SaleSummaryRetailState extends State<SaleSummaryRetail> {
  DateTime? fromDate;
  DateTime? toDate;
                ...
                children: [
                  ...
                  pw.Table(
                    ...
                    children: [
                      ...
                      _buildPdfTableRow('Total Bank', formatter.format(reportData!.totalAdvance), font, boldFont),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildReportRow('Total Bank', formatter.format(reportData!.totalAdvance)),
