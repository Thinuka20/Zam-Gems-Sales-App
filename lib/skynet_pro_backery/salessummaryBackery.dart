...
class SalesReportData {
  ...
  factory SalesReportData.fromJson(Map<String, dynamic> json) {
    return SalesReportData(
      ...
      billCount: json['billCount']?.toDouble() ?? 0.0,
    );
  }
}

class SaleSummaryReportBackery extends StatefulWidget {
  // Renamed to SoldItemsReport
  const SaleSummaryReportBackery({super.key});

  @override
  State<SaleSummaryReportBackery> createState() => _SaleSummaryReportBackeryState();
}
...
class ApiService {
  ...
  Future<SalesReportData?> getSalesSummaryReport({
    ...
    try {
      ...
      final uri = Uri.parse('$baseUrl/salesummaryreportbackery')
          .replace(queryParameters: queryParameters);
...
class _SaleSummaryReportBackeryState extends State<SaleSummaryReportBackery> {
  DateTime? fromDate;
  DateTime? toDate;
                ...
                children: [
                  ...
                  pw.Table(
                    ...
                    children: [
                      ...
                      _buildPdfTableRow('Average Ticket', formatter.format(reportData!.totalIncome / reportData!.billCount), font, boldFont, isTotal: true),
                    ],
                  ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildReportRow('Average Ticket', formatter.format(reportData!.totalIncome / reportData!.billCount), isBold: true),
              ],
            ),
          ),
          const SizedBox(height: 24),
