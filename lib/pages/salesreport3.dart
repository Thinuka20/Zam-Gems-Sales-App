...
class SalesReportPage3 extends StatefulWidget {
  const SalesReportPage3({super.key});



  @override
  SalesReportPageState3 createState() => SalesReportPageState3();
}
...
class SalesReportPageState3 extends State<SalesReportPage3> with PwaPdfGenerator {
  DateTime? fromDate;
  DateTime? toDate;
