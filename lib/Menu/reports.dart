...
import 'package:genix_reports/Skynet_Pro/itemwisepurchasereport.dart';
import 'package:genix_reports/Skynet_Pro/supplierpurchasereport.dart';
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                GetBuilder<LoginController>(
                  builder: (controller) {
                    if (controller.specialType == "Retail-Pro") {
                      return Column(
                        children: [
                          InkWell(
                            onTap: () {
                    ...
                    if (controller.specialType == "Retail-Pro") {
                      return Column(
                        children: [
                          InkWell(
                            onTap: () {
                              Get.to(() => const DailyPurchaseReport());
                            },
                            child: Card(
                              color: Colors.white,
                              child: Container(
                ...
                GetBuilder<LoginController>(
                  builder: (controller) {
                    if (controller.specialType == "SKYNET Pro" ||
                        controller.specialType == "SKYNET Pro-Hotel" ||
                        controller.specialType == "SKYNET Pro-Bakery") {
                      return Column(
                        children: [
                          InkWell(
                            onTap: () {
                              Get.to(() =>
                                  const SupplierPurchaseReport()); // Navigate to SalesReport
                            },
                            child: Card(
                              color: Colors.white,
                              child: Container(
                          ...
                          InkWell(
                            onTap: () {
                              Get.to(() =>
                                  const ItemwisePurchaseReport()); // Navigate to SalesReport
                            },
                            child: Card(
                              color: Colors.white,
                              child: Container(
